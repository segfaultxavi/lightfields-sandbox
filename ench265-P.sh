...
do
  gst-launch-1.0 filesrc location=$1 ! videoparse width=624 height=432 format=nv12 ! videoconvert ! video/x-raw,format=I420 ! x265enc bitrate=$i speed-preset=9 ! filesink location=$2-$i
